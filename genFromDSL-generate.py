...
def genXML(dat):
    ...
    # root.append(qoslib)
    # root.append(types)
    # root.append(domainlib)
    # root.append(domainparticlib)
...
def generate():
    ...
    while index < len(data) / 4:
        ...
        # print(data[4 * index + 0])
        # print(data[4 * index + 1])
        # print(data[4 * index + 2])
        # print(data[4 * index + 3])
     #   print("----------------------------")
        index = index + 1
    #print("==========================================")
    print(datavars)
